...
import bgImage from "../assets/images/herosection.png";
...
const Herosection = () => {
  return (
    ...
    >
      <div className=" z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      <div>
